...
import { Briefcase, ShieldCheck, Settings, DollarSign, Monitor, Activity, Airplay, Cpu, Laptop, HardDrive, Microchip, TvMinimalPlay, Keyboard } from 'lucide-react'; // Pakai icon lucide-react (ikon modern)

const Layanan = () => {
    return (
        <div id="layanan" className="py-16 px-6 md:px-20 bg-white text-black">
