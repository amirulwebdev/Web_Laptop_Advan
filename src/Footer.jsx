...
const Footer = () => {
    return (
        <footer id="footer" className="bg-gray-900 text-white antialiased font-montserrat">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4 md:w-2/3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-400">
                                ...
                                <li className="mb-4">
                                    <a href="footer" className="hover:underline">Support Center</a>
                                </li>
                                <li className="mb-4">
                                    <a href="footer" className="hover:underline">Hire Us</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="text-gray-400">
                                <li className="mb-4">
                                    <a href="footer" className="hover:underline">Discord</a>
                                </li>
                                <li className="mb-4">
                                    <a href="footer" className="hover:underline">Github</a>
                                </li>
                                <li className="mb-4">
                                    <a href="footer" className="hover:underline">Twitter</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="text-gray-400">
                                <li className="mb-4">
                                    <a href="footer" className="hover:underline">License</a>
                                </li>
                                <li className="mb-4">
                                    <a href="footer" className="hover:underline">Privacy Policy</a>
                                </li>
                                <li className="mb-4">
                                    <a href="footer" className="hover:underline">Terms & Conditions</a>
                                </li>
                                <li className="mb-4">
                                    <a href="footer" className="hover:underline">Brand Guideline</a>
                                </li>
                            </ul>
                        </div>
                    </div>
